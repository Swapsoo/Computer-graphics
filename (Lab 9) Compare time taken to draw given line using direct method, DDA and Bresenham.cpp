...
void plotPixel()
{
 ...
 direct_end = clock();
 cout << endl;
 cout << "The time taken by Direct method:" << (float)(direct_end - direct_start) / 
 CLOCKS_PER_SEC << " seconds" << endl;
 cout << "The time taken by DDA algorithm:" << (float)(dda_end - dda_start) / CLOCKS_PER_
 SEC << " seconds" << endl;
 cout << "The time taken by Bresenham algorithm:" << (float)(bresenham_end -
bresenham_start) / 
 CLOCKS_PER_SEC << " seconds" << endl;
}
int main (int argc, char *argv[])
{
 ...
 glutCreateWindow("Lab 9 Swapnil Lamsal");
